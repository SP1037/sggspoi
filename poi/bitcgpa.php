...
<body>
<form method="GET" action="bitcgpa.php">
<div class="box">
<p style="text-align: center;font-size: 30px;"><u>B-TECH IT GGPA</u></p>
<?php
...
?>
 ...
 <div class="input-group mb-3">
  ...
  <input type="tel" class="form-control" placeholder="Enter Sem_2 Pointer(project)" aria-label="Example text with button addon" aria-describedby="button-addon1" name="sem2">
</div>
